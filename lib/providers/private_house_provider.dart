...
class PrivateHouseProvider extends ChangeNotifier {
  late String _street ;
  ...
  late List<Map<String, dynamic>> _addCleanerOptionsDataList;
  ...
  Future<void> init() async {
    ...
    _selectionsAddCleanOptions =
        List.generate(_addCleanerOptionsDataList.length, (index) => false);
    ...
    _addCleanerOptionsIncFunc =
        List.generate(_addCleanerOptionsDataList.length, (index) {
      return () {
 ...
 late List<Widget> categoriesList = <Widget>[
  ...
  List<Widget> dryCleanerList() {
    return List.generate(
        _addCleanerOptionsDataList.length,
        (index) => ServiceWidgetExtend(
              title: _addCleanerOptionsDataList[index]['title'],
              price: _addCleanerOptionsDataList[index]['price'],
              ...
              image: (selectionsAddCleanOptions[index] == true) &&
                      (!_addCleanerOptionsDataList[index]['isSingle'])
                  ? CounterSecondaryWidget(
                      _addCleanerOptionsCount[index],
                  ...
                  : SvgPicture.asset(
                      _addCleanerOptionsDataList[index]['uriPicture']),
            ));
  }
