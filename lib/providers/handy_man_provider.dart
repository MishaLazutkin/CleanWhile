...
class HandyManProvider extends ChangeNotifier {
  ...
  Future<void> init() async {
    ...
    _discountDataList = [
      {'percent': '-20%', 'title': 'Раз на тиждень', 'price': '119.92 zł'},
      {'percent': '-15%', 'title': 'Раз на два тижні', 'price': '127.42 zł'},
      {'percent': '-10%', 'title': 'Раз на місяць', 'price': '134.91 zł'},
      {'title': 'Разове прибирання', 'price': '149.90 zł'},
    ];
  ...
  List<Widget> discountList() {
    return List.generate(
        ...
        (index) => Discount(
              ...
              textColor:
                  _selectedDiscountIndex == index ? Colors.white : Colors.black,
          backgroundColor: selectedDiscountIndex == index
              ? AppColor.primary
