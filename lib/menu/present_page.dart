...
class _PresentPageState extends State<PresentPage>
    with FullscreenLoaderMixin<PresentPage> {
  final TextEditingController certEmail = TextEditingController();
            ...
            child: Row(
              children: [
                SvgPicture.asset(
                  ...
                  color:  provider.isCheckedContract? const Color.fromRGBO(255, 255, 255, 1):const Color.fromRGBO(189, 71, 64, 1),
                ),
                const SizedBox(
                  width: 18,
                ),
